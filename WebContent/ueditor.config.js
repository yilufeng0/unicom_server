...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["undo","redo","link","unlink","insertunorderedlist","insertorderedlist","cleardoc","selectall","searchreplace","|","simpleupload","time","anchor","blockquote","bold","italic","underline","fontborder","strikethrough","forecolor","removeformat","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","imagenone","imageleft","imageright","imagecenter"]]
        ...
        ,initialContent:'This input your content!'    //鍒濆鍖栫紪杈戝櫒鐨勫唴瀹�涔熷彲浠ラ�杩噒extarea/script缁欏�锛岀湅瀹樼綉渚嬪瓙
        ...
        //濡傛灉鑷畾涔夛紝鏈�ソ缁檖鏍囩濡備笅鐨勮楂橈紝瑕佷笉杈撳叆涓枃鏃讹紝浼氭湁璺冲姩鎰�
        ...
        //tab
        //鐐瑰嚮tab閿椂绉诲姩鐨勮窛绂�tabSize鍊嶆暟锛宼abNode浠�箞瀛楃鍋氫负鍗曚綅
        //,tabSize:4
        //,tabNode:'&nbsp;'
